...
#define GAME_CMSG_INSTANCE_CHAR_CREATION_START_RECV (GAME_CMSG_MASK | 0x0087) // 135
#define GAME_CMSG_INSTANCE_CHAR_CREATION_READY_RECV (GAME_CMSG_MASK | 0x0088) // 136
