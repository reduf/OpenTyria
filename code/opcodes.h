...
#define GAME_CMSG_CHAR_CREATION_REQUEST_PLAYER          (GAME_CMSG_MASK | 0x0087) // 135
#define GAME_CMSG_CHAR_CREATION_REQUEST_ARMORS          (GAME_CMSG_MASK | 0x0088) // 136
...
#define GAME_SMSG_UPDATE_AGENT_INT_PROPERTY             (0x009E) // 158
#define GAME_SMSG_UPDATE_AGENT_INT_PROPERTY_TARGET      (0x009F) // 159
#define GAME_SMSG_AGENT_ATTR_PLAY_EFFECT                (0x00A0) // 160
#define GAME_SMSG_UPDATE_AGENT_FLOAT_PROPERTY           (0x00A1) // 161
#define GAME_SMSG_UPDATE_AGENT_FLOAT_PROPERTY_TARGET    (0x00A2) // 162
