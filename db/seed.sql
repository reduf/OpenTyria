...
CREATE TABLE characters (
    ...
    file_id_body              INTEGER DEFAULT 0,
    file_id_legs              INTEGER DEFAULT 0,
    file_id_head              INTEGER DEFAULT 0,
    file_id_boots             INTEGER DEFAULT 0,
    file_id_gloves            INTEGER DEFAULT 0,
    colors_body               INTEGER DEFAULT 0,
    colors_legs               INTEGER DEFAULT 0,
    colors_head               INTEGER DEFAULT 0,
    colors_boots              INTEGER DEFAULT 0,
    colors_gloves             INTEGER DEFAULT 0,
