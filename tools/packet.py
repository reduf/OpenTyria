...
class FileBuilder:
    ...
    def build(self, include_rva):
        ...
        for desc in self.desc_ls_clt:
            builder.append(desc.build(image_base, 'AUTH_CMSG', include_rva))

        for desc in self.desc_ls_srv:
            builder.append(desc.build(image_base, 'AUTH_SMSG', include_rva))

        for desc in self.desc_gs_clt:
            builder.append(desc.build(image_base, 'GAME_CMSG', include_rva))

        for desc in self.desc_gs_srv:
            builder.append(desc.build(image_base, 'GAME_SMSG', include_rva))

        builder.append(self.create_desc_array(self.desc_ls_clt, 'AUTH_CMSG'))
        builder.append(self.create_desc_array(self.desc_ls_srv, 'AUTH_SMSG'))
        builder.append(self.create_desc_array(self.desc_gs_clt, 'GAME_CMSG'))
        builder.append(self.create_desc_array(self.desc_gs_srv, 'GAME_SMSG'))
